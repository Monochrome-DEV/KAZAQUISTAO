...
class WeekData {
	...
	public static function createWeekFile():WeekFile {
		var weekFile:WeekFile = {
			songs: [["Bopeebo", "dad", [146, 113, 253], "unknown"], ["Fresh", "dad", [146, 113, 253], "unknown"], ["Dad Battle", "dad", [146, 113, 253], "unknown"]],
	...
	public static function reloadJokeFiles(isStoryMode:Null<Bool> = false)
		{
			weeksList = [];
			weeksLoaded.clear();
			#if MODS_ALLOWED
			...
			for (i in 0...sexList.length) {
				for (j in 0...directories.length) {
					var fileToCheck:String = directories[j] + 'weeks/' + 'joke/' + sexList[i] + '.json';
	...
	public static function reloadExtraFiles(isStoryMode:Null<Bool> = false)
		{
			...
			for (i in 0...directories.length) {
				var directory:String = directories[i] + 'weeks/' + 'extras/';
